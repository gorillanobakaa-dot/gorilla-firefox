...
**This applies to both builds.** The change lives in `patches/07.TOOLKIT`,
which is marked cross-platform and enabled on Linux and Windows alike. If you
installed the Linux `.deb`, you have it too.
