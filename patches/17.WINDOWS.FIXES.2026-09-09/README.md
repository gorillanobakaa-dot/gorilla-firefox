...
- `browser/modules/GorillaBuiltinExtensions.sys.mjs`  
  registers bundled extensions via maybeInstallBuiltinAddon (the VISIBLE app-builtin location) and pins the toolbar button once; generated by working scripts/add_builtin_extension.py
